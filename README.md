...
`version` input adds a versioned tag (e.g. `0.1.0`) alongside `latest` and
creates a matching GitHub Release (`v0.1.0`). Leave it empty to push `latest`
only, with no Release.
